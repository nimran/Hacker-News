...
public class AppUtils {
    ...
    public static CharSequence getPoints(int point) {
        ...
        span1.setSpan(new AbsoluteSizeSpan(25), 0, text1.length(), SPAN_INCLUSIVE_INCLUSIVE);
        SpannableString span2 = new SpannableString(text2);
        span2.setSpan(new AbsoluteSizeSpan(16), 0, text2.length(), SPAN_INCLUSIVE_INCLUSIVE);
